...
public class GetAPI extends AsyncTask<Void, Void, Void> {
    ...
    public static String url = "https://freewebking.000webhostapp.com/contacts/productJson.json";
    ...
    public GetAPI(Context context, ListView listViewBai1){
    ...
    protected void onPostExecute(Void unused) {
        ...
        listViewBai1.setAdapter(productAdpater);
    }
}
